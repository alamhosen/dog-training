        ...
        <div className='mt-20'>
            <footer class="footer p-10 text-base-content">
                <div>
                    ...
                    <a class="hover:text-blue-400 cursor-pointer">Veterinarian</a>
                    <a class="hover:text-blue-400 cursor-pointer">Grooming</a>
                    <a class="hover:text-blue-400 cursor-pointer">Adoption</a>
                    <a class="hover:text-blue-400 cursor-pointer">Agility</a>
                </div>
                <div>
                    <span class="footer-title">Company</span>
                    <a class="hover:text-blue-400 cursor-pointer">About us</a>
                    <a class="hover:text-blue-400 cursor-pointer">Contact</a>
                    <a class="hover:text-blue-400 cursor-pointer">Jobs</a>
                    <a class="hover:text-blue-400 cursor-pointer">Press kit</a>
                </div>
                <div>
                    <span class="footer-title">Legal</span>
                    <a class="hover:text-blue-400 cursor-pointer">Terms of use</a>
                    <a class="hover:text-blue-400 cursor-pointer">Privacy policy</a>
                    <a class="hover:text-blue-400 cursor-pointer">Cookie policy</a>
                </div>
            </footer>
            <footer class="footer px-10 py-4 text-base-content border-base-300">
                <div class="items-center grid-flow-col">
                    ...
                    <p><span className='text-xl' data-aos="fade-up"
                        data-aos-duration="1500">Brand Name</span><br />Providing reliable service since 1993</p>
                </div>
                <div class="md:place-self-center md:justify-self-end text-3xl">
