        ...
        <div className='mt-20'>
            <footer class="footer p-10 text-base-content">
                <div>
                    ...
                    <a class="link link-hover">Veterinarian</a>
                    <a class="link link-hover">Grooming</a>
                    <a class="link link-hover">Adoption</a>
                    <a class="link link-hover">Agility</a>
                </div>
                <div>
            ...
            <footer class="footer px-10 py-4 text-base-content border-base-300">
                <div class="items-center grid-flow-col">
                    ...
                    <p><span className='text-xl'>Brand Name</span><br />Providing reliable service since 1993</p>
                </div>
